...
async function connectToWA() {
  ...
  console.log("Connecting ❤️S_A_D_U_W_A❤️");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("❤️S_A_D_U_W_A❤️ installed successful ✅");
      console.log("❤️S_A_D_U_W_A❤️ connected to whatsapp ✅");

      let up = `❤️S_A_D_U_W_A❤️ connected successful ✅`;
      let up1 = `Hello SADUWA, I made bot successful`;
      ...
      robin.sendMessage("94771131574@s.whatsapp.net", {
        image: {
          url: `https://raw.githubusercontent.com/saduwa-bot/BOT-HELPER/refs/heads/main/SADUWA%20BOT.png`,
        },
        caption: up1,
...
app.get("/", (req, res) => {
  res.send("hey, SADUWA BOT  started✅");
});
app.listen(port, () =>
